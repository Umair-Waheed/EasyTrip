...
const Login = ({login,setLogin,providerLogin,setProviderLogin}) => {
    ...
    const handleGoogleLogin = async () => {
        try {
          ...
          if (login) {
            ...
            newUrl += currState === "Login" ? "api/serviceprovider/login" : "api/serviceprovider/register";
          }
    ...
    return (
        ...
        <div className="login ">
            ...
            <form action="" onSubmit={onLogin} className='login-container w-full max-w-[80%] sm:max-w-[350px] md:max-w-[400px] lg:max-w-[450px] mx-auto p-4  '>
                ...
                <div className="login-info">
                    {currState === "Login"?<></> 
                    : <input name='name' onChange={onChangeHandler} value={data.name} type="text" placeholder="fullname" required/>
                    }
                ...
                <div className='login-condition'>
                    ...
                    <label htmlFor=''>By continue, i agree to the terms of use & privacy policy.</label>
                </div>
                ...
                <div className="google-login-btn">
                    ...
                    <button type="button" onClick={handleGoogleLogin}><img src={assets.google_icon} alt="google" />{currState} with Google</button>
                </div>

                <div className="form-switch">
                    {currState === "Login"
                    ? <p>Create a new account? <span onClick={()=>setCurrState("SignUp")}>SignUp here!</span></p>
