...
const ProviderPayments = ({providerId,formatPrice}) => {
                            ...
                            <div className="p-6">
                                <div className="flex justify-end gap-1 mb-2 items-center">
                                    ...
                                    className={`px-3 py-1 rounded-full text-xs font-medium ${
                                        ...
                                        ? statusColors["released"] || 'bg-green-100 text-green-800'
                                        : statusColors[payment.status] || 'bg-gray-100 text-gray-800'
                                    }`}
                                    >
                                    Payment: {payment.status === "completed" ? "released" : payment.status}
                                    </span>
                                ...
                                <div className="mt-2 pt-4 border-t border-gray-100">
                                    ...
                                    <div className="flex justify-between items-center mb-2">
                                        ...
                                        <span className="text-md font-medium text-[#1EBEB1] ">
